...
diferencia del color de acento (punto 12, ver
`vendor_service.resolver_acento_vendor`). Ver
`claude/roadmap-monetizacion-e-link.md`, Fase 2, punto 13 — "absorbe la
elección de tipografía": no hay un selector de fuente aparte, cada
plantilla ya trae la suya.
...
como `None`/clave vacía en `Vendor.plantilla`, y sigue viviendo en
`tienda/publica.html`.
"""
