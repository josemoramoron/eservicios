"""Personalización de perfil, verificación, plan e-link Plus y contraseña.

Extraído de vendor_service.py (bloque "Perfil/Plan Plus" del split de
god-files, 2026-09-26). Cubre la actualización de los datos de
personalización de la tienda (`actualizar_perfil`), las dos solicitudes
que mandan correo de aviso a eServicios (verificación y pago de e-link
Plus), todo el chequeo de vigencia de plan (real y de prueba) y el
...
from app.models import PlanVendor, Vendor
